...
{
  const int ColorTableSize = 16384;
  ...
  try
    ...
    while(!ri.IsAtEnd())
      {
      unsigned int val = rand() % ColorTableSize;
  ...
  typedef IdentityMap<TPixel, ColorTableSize> MappingFunction;
  typedef itk::Octree<TPixel, ColorTableSize, MappingFunction> OctreeType;
